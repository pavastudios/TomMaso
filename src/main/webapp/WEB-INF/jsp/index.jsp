...
<nav class="uk-navbar-container" uk-navbar>
    ...
    <div class="uk-navbar-left">
        ...
        <ul class="uk-navbar-nav">
            <li class="uk-active"><a href="#"><img src="${pageContext.request.contextPath}/images/logo.png"
                                                   style="max-width: 50px;" srcset=""></a></li>
            <li><a href="#">Home</a></li>
        ...
        <div class="uk-grid uk-grid-large uk-grid-stack" data-uk-grid="">
            <div class="uk-width-1-2@m uk-first-column">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore
                    ...
                    to: <a href="#" title="">pava@studios.com</a></p>
                <div>
                    <a href="" class="uk-icon-button uk-icon" data-uk-icon="twitter">
                    ...
                    <a href="" class="uk-icon-button uk-icon" data-uk-icon="facebook">
                        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11,10h2.6l0.4-3H11V5.3c0-0.9,0.2-1.5,1.5-1.5H14V1.1c-0.3,0-1-0.1-2.1-0.1C9.6,1,8,2.4,8,5v2H5.5v3H8v8h3V10z"></path>
                        </svg>
                    </a>
                    <a href="" class="uk-icon-button uk-icon" data-uk-icon="instagram">
                        <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
