				...
				<fieldset class="uk-fieldset">
					...
					<div class="uk-margin-small">
						<div class="uk-inline uk-width-1-1">
							...
							<input class="uk-input uk-border-pill" required placeholder="Password" type="password" name="password1">
						</div>
					</div>
					<div class="uk-margin-small">
						<div class="uk-inline uk-width-1-1">
							<span class="uk-form-icon uk-form-icon-flip" data-uk-icon="icon: lock"></span>
							<input class="uk-input uk-border-pill" required placeholder="Ripeti password" type="password" name="password2">
						</div>
					</div>
					<div class="uk-margin-bottom">
						<button type="submit" class="uk-button uk-button-primary uk-border-pill uk-width-1-1">Registrati</button>
					</div>
				</fieldset>
			</form>
		</div>
